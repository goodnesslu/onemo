...
export default function Accordion({ question, answer, className }) {
  ...
  return (
    <div
      ...
      className="group rounded-md border-2 border-black shadow-base"
    >
      <button
        role="button"
        aria-expanded={showContent}
        className={cn(
          'flex w-full items-center transition-[border-radius] justify-between border-b-0 group-data-[state=closed]:rounded-base group-data-[state=open]:rounded-t-base group-data-[state=open]:border-b-2 border-b-black bg-main text-left  p-4 md:p-5 font-heading',
          className
        )}
        onClick={() => {
